...
#t = 0:Δt:0.002;  #Define time from 0 to 0.001s in steps of 0.0000125s
...
#println(cuhre(((t, f)->f[1]=A*cos.(ω0*t[1]))))
...
plot(t,v_integ,".-")
xlabel("Time in seconds")
ylabel("Integratedsinusoid to be modulated 1kHz")=#